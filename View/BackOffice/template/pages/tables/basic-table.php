...
if (isset($_POST["search"])) {
  if (!empty($_POST["search"])) {
    $search = ($_POST["search"]);
    $list = $UserC->listuserbyusername($search);
  }
}
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top">
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item dropdown d-none d-lg-block" id="recherche">
                ...
                <div class="input-group mb-3  mx-5 px-5">
                  <span class="input-group-text" id="basic-addon1">
                    <div class="form-control-icon">
                      <i class="bi bi-search" fill="currentColor"></i>
                    </div>
                    <input type="tel" class="form-control " placeholder="Chercher Utilisateur..." name="search" style="width: 300px;">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                ...
                <p class="fw-light text-muted mb-0">Hello Admin</p>
              </div>
              <div id="logoutOption1">
                <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-power text-primary me-2" ></i>Sign Out</a>
              </div>

              <script>
                // Get the logout element by its ID
                var logoutOption1 = document.getElementById('logoutOption1');

                // Add a click event listener to the logout element
                logoutOption1.addEventListener('click', function() {
