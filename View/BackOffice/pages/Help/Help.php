        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-6 grid-margin stretch-card">
              ...
              <?php
include('D:/Esprit 2eme/progs/xampp/htdocs/Unify_SocialNetwork-aziz/Controller/ticketC.php');
...
<table class="ticket-table" border="1" align="center" width="70%">
    ...
    <tr>
        ...
        <td>
            <a href="../../../FrontOffice/Tickets/deleteticket.php?id=<?= $ticket['ticket_id']; ?>">Delete</a>
        </td>
        <td>
            <form method="POST" action="reply.php">
                <a href="../../../FrontOffice/Tickets/reply.php?id=<?= $ticket['ticket_id']; ?>">Reply </a>
            </form>
        </td>
    </tr>
<?php } ?>
