<?php
include('D:/Esprit 2eme/progs/xampp/htdocs/Unify_SocialNetwork-aziz/Controller/UserC.php');
$UserC = new UserC();
$UserC->listUser();
$list = $UserC->listUser();
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="/Unify_SocialNetwork-aziz/View/FrontOffice/Login/updateUser.php?id=<?php echo $j['Id_User']; ?>">Update</a>
                          </td>
                          <td>
                            <a href="/Unify_SocialNetwork-aziz/View/FrontOffice/Login/deleteUser.php?id=<?php echo $j['Id_User']; ?>">delete</a>
