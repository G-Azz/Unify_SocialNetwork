    ...
    <div class="feed" id="feed">
        ...
        <div class="widgets">
            <div class="profile-container">
                <img src="https://i.pinimg.com/originals/a6/58/32/a65832155622ac173337874f02b218fb.png" alt="User Avatar" class="avatar">
                <div class="user-info">
                    <span class="name">Gharbi Aziz</span>
                    <span class="username">@Sayonx1</span>
                </div>
                <button class="more-actions" aria-label="More actions">...</button>
            </div>
