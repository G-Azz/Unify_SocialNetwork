...
<body>
<?php
echo "Post Type: " . htmlspecialchars($post->getPostType()) . ", Channel ID: " . htmlspecialchars($post->getChannelId());
?>
    <!-- sidebar starts -->
    <div class="sidebar">
            ...
            <div class="post__body">
                <div class="post__header">
                    ...
                    <div class="post__footer">
                       ...
                       <button onclick="setInitialState(<?php echo htmlspecialchars($post->getPostType())?>,<?php echo htmlspecialchars($post->getPostType())?>)"   > <span class="material-icons" >edit</span></button>
