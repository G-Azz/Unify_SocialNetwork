      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="../../index.php">
            <img src="../../BackOffice/images/loogo.png" alt="logo" />
          </a>
          <a class="navbar-brand brand-logo-mini" href="../../index.php">
            <img src="../../BackOffice/images/logo-mini.svg" alt="logo" />
          </a>
        </div>
      </div>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/ss/View/BackOffice/../BackOffice/pages/tables/basic-table.php">Users Management</a></li>
              </ul>
            </div>
          </li>
          ...
          <a class="nav-link" data-bs-toggle="collapse" href="#icons" aria-expanded="false" aria-controls="icons">
            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="../../BackOffice/pages/Help/Help.php">Tickets Management</a></li>
        ...
        try {
            ...
            $mail = new PHPMailer(true);
                try {
                    ...
                    $mail->send();
                    echo '<script>window.location.href="../../BackOffice/pages/Help/Help.php";</script>';
                    exit();
...
<div class="khalil">
    ...
    <div class="reply-box">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Premium <a href="https://www.bootstrapdash.com/" target="_blank">Bootstrap admin ../BackOffice</a> from BootstrapDash.</span>
  ...
  <script src="../../BackOffice/js/../BackOffice.js"></script>
