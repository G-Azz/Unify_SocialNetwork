      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="../../index.php">
            <img src="../template/images/loogo.png" alt="logo" />
          </a>
        ...
        <ul class="nav">
          ...
          <a class="nav-link" data-bs-toggle="collapse" href="#icons" aria-expanded="false" aria-controls="icons">
            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="../template/pages/Help/Help.php">Tickets Management</a></li>
        ...
        try {
            ...
            $mail = new PHPMailer(true);
                try {
                    ...
                    $mail->send();
                    echo '<script>window.location.href="../template/pages/Help/Help.php";</script>';
                    exit();
