...
if (
    ...
    if (
        ...
        header('Location: /ss/View/Uprofile.php');
    } else
                            ...
                            <div class="tab-pane fade active show" id="account-general">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-1" value="nmaxwell" name="Username">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Name</label>
                                        <input type="text" class="form-control" value="Nelle Maxwell" name="Name">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">E-mail</label>
                                        <input type="text" class="form-control mb-1" value="nmaxwell@mail.com" email="Email">
        ...
        <div class="text-right mt-3">
            ...
            <script>
                document.getElementById('cancelButton').addEventListener('click', function() {
                    ...
                    window.location.href = '/Unify_SocialNetwork-aziz/View/FrontOffice/Home/postDD.php';
                });
            </script>
